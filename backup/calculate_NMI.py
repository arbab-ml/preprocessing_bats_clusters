...
kal_results=pd.read_csv("/media/rabi/Data/ThesisData/audio data analysis/audio-clustering/plots_15march_b/cluster_kaleidoscope.csv")
...
result=normalized_mutual_info_score(merged_both["TOP1MATCH*"], merged_both["Prediction"],)
