...
cluster_kaleidoscope=pd.read_csv("/media/rabi/Data/ThesisData/audio data analysis/audio-clustering/plots_15march_b/cluster_kaleidoscope.csv")
#all_files_from_kaleidoscope=cluster_kaleidoscope["INDIR"]+'/'+cluster_kaleidoscope["FOLDER"]+'/'+cluster_kaleidoscope["IN FILE"]

for index, row_data in tqdm(cluster_kaleidoscope.iterrows()):
	try:
