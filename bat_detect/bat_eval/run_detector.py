...
if __name__ == "__main__":
    ...
    # params
    detection_thresh = 0.80      # make this smaller if you want more calls
    do_time_expansion = False# (default: True)       # if audio is already time expanded set this to False
    ...
    op_file_name_total = os.path.join(op_ann_dir, 'batdetect_6Aug_80_threshold.csv')
